...
function setupLoggerAndTelemetry(bus, log, analytics, userTraits, mongosh_version) {
    ...
    bus.on('mongosh:mongocryptd-tryspawn', function (ev) {
        log.info('MONGOCRYPTD', (0, mongodb_log_writer_1.mongoLogId)(1000000016), 'mongocryptd', 'Trying to spawn mongocryptd', ev);
    });
    bus.on('mongosh:mongocryptd-error', function (ev) {
        var _a;
        log.warn('MONGOCRYPTD', (0, mongodb_log_writer_1.mongoLogId)(1000000017), 'mongocryptd', 'Error running mongocryptd', {
            ...ev,
            error: (_a = ev.error) === null || _a === void 0 ? void 0 : _a.message
        });
    });
    bus.on('mongosh:mongocryptd-log', function (ev) {
        log.info('MONGOCRYPTD', (0, mongodb_log_writer_1.mongoLogId)(1000000018), 'mongocryptd', 'mongocryptd log message', ev);
    });
