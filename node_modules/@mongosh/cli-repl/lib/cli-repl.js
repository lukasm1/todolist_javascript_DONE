...
class CliRepl {
    constructor(options) {
        ...
        const id = new service_provider_core_1.bson.ObjectId().toString();
        this.config = {
            userId: id,
        ...
        this.mongocryptdManager = new mongocryptd_manager_1.MongocryptdManager((_b = options.mongocryptdSpawnPaths) !== null && _b !== void 0 ? _b : [], this.shellHomeDirectory, this.bus);
