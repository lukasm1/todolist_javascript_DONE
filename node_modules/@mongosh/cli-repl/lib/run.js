    ...
    try {
        ...
        if (options.help) {
            ...
            if (process.execPath === process.argv[1]) {
                await (0, index_1.runSmokeTests)(smokeTestServer, process.execPath);
            }
            else {
                await (0, index_1.runSmokeTests)(smokeTestServer, process.execPath, process.argv[1]);
            }
        }
        else {
            ...
            if (process.execPath === process.argv[1]) {
                ...
                mongocryptdSpawnPaths = await (0, index_1.getMongocryptdPaths)();
            }
            ...
            const driverOptions = (0, index_1.mapCliToDriver)(options);
            const driverUri = (0, service_provider_server_1.generateUri)(options);
            const title = `mongosh ${(0, history_1.redactURICredentials)(driverUri)}`;
            process.title = title;
